---
title: "Hermes Agent for VS Code: Command Palette Reference"
sidebarTitle: "Commands"
description: "All Hermes Agent commands for VS Code — open chat, send selections, apply diffs, manage sessions, and configure from the Command Palette."
---
