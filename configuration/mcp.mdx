---
title: "Forward MCP Servers to Hermes Agent"
sidebarTitle: "MCP Servers"
description: "Hermes Agent reads your Cursor and VS Code MCP server configurations and forwards them automatically when starting a new session."
---
