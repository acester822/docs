---
title: "Get Started with Hermes Agent in VS Code in 5 Minutes"
sidebarTitle: "Quick Start"
description: "Set your API key, open the Hermes chat panel, and send your first message to Hermes Agent — the whole process takes under five minutes."
---
