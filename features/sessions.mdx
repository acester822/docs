---
title: "Manage Multiple Chat Sessions in Hermes Agent"
sidebarTitle: "Sessions"
description: "Run parallel Hermes Agent conversations, switch between them, rename or delete sessions, and carry prior context into new chats with session memory attachment."
---
...
- Click **+ New** in the chat toolbar to open a fresh session.
...
| **All** | All attachable messages, truncated to a ~8 000-token budget if needed |
